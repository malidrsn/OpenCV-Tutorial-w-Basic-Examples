# konturların doşında perde oluşmasını sağlar iç bükeyleri dış bükey yapmaya yarar örtü üretir
...
for i in range(len(contours)):
    cv2.drawContours(bg, contours, i, (255, 0, 0), 3, 8, hierarchy=hierarchy)
